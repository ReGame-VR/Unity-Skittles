...
while s.IsRunning
    ...
    switch(getappdata(fig, 'simStep'))
        ...
        case 'ballReleased'
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%% don't need exploration score for this condition!
            %            if EScore > 9
            %           delete(ms1)
            %        end
            %  for i=trial-5:trial-1
            %             a=0; v=0;
...
trialName=strcat(subject,'_',num2str(visit),'_',num2str(session)); % same as name of bin file 
